...
namespace Cortex.API.Database.Migrations
{
    ...
    [Migration("20260509000553_AddIntegrationConnectionLastTestMode")]
    partial class AddIntegrationConnectionLastTestMode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cortex.API.Models.IntegrationConnection", b =>
                {
                    ...
                    b.Property<string>("LastConnectionTestHealthStatus")
                        .HasMaxLength(48)
                    ...
                    b.Property<string>("LastConnectionTestMode")
                        .HasMaxLength(48)
                        .HasColumnType("nvarchar(48)");
            ...
            modelBuilder.Entity("Cortex.API.Models.IntegrationConnectionCredential", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AuthModeSnapshot")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.ToTable("IntegrationConnectionCredentials");
                });
            ...
            modelBuilder.Entity("Cortex.API.Models.IntegrationConnectionCredential", b =>
                {
                    b.HasOne("Cortex.API.Models.IntegrationConnection", "IntegrationConnection")
                        .WithOne("Credential")
                        .HasForeignKey("Cortex.API.Models.IntegrationConnectionCredential", "IntegrationConnectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
